...
\draw[->] (0,0) -- (0, 3.5) node[above] {$P(X=x)$};

% Y-axis labels
\node[left] at (0,3) {$0.729$};
\node[left] at (0,2) {$0.243$};
\node[left] at (0, 1) {$0.027$};
\node[left] at (0,0.5) {$0.001$};

% Bars (NOTE: last bar is artificially boosted for visibility)
\draw[fill=blue!40] (0.7,0) rectangle (1.3,3);
\draw[fill=blue!40] (1.7,0) rectangle (2.3,2);
\draw[fill=blue!40] (2.7,0) rectangle (3.3,1);
\draw[fill=blue!40] (3.7,0) rectangle (4.3,0.5); % boosted height
...
\node[above] at (1,3) {$0.729$};
\node[above] at (2,2) {$0.243$};
\node[above] at (3,1) {$0.027$};
\node[above] at (4,0.5) {$0.001$};
