...
\textbf{Def:}  
The function \(f(x,y)\) is a \underline{joint probability density function (PDF)} of continuous random variables \(X\) and \(Y\) if:
...
The joint PDF is a surface above the \(xy\)-plane, and probabilities correspond to the \textbf{volume under the surface}.
